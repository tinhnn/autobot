...
class SSD1306Base(object):
    ...
    def __init__(self, width, height, rst, dc=None, sclk=None, din=None, cs=None,
        ...
        self._i2c = pigpio.pi()
        self._i2c_hdl = self._i2c.i2c_open(i2c_bus, i2c_address)
    ...
    def command(self, c):
        ...
        self._i2c.i2c_write_byte_data(self._i2c_hdl, control, c)
    ...
    def end(self):
        """End class """
        self._i2c.i2c_close(self._i2c_hdl)
        self._i2c.stop()
    ...
    def display(self):
        ...
        for i in range(0, len(self._buffer), 16):
            control = 0x40   # Co = 0, DC = 0
            self._i2c.i2c_write_i2c_block_data(self._i2c_hdl, control, self._buffer[i:i+16])
